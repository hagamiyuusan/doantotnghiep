...
export default function UserProfile() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.VITE_BASE_URL}/UserService/changepassword`, {
            ...
            <form action='' className=' px-3' onSubmit={handleSubmit}>
              ...
              <div className='flex items-center gap-6 mb-7'>
                ...
                <input
                  ...
                  onChange={(e) => {
                    setCurrentPassword(e.target.value), setError('')
                  }}
              ...
              <div className='flex justify-center items-center'>
                <button type='submit' className='bg-red-600 mt-10 pr-2 pl-2 '>
                  Update Profile
                </button>
              </div>
            </form>
